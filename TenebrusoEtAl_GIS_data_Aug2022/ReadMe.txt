...
ReadMe file update: Last updated August 18, 2022



GIS shapefiles and georeferenced maps included in this database were developed to accompany:

	Tenebruso, C., Lorenzo-Trueba, J., Ciarletta, D., Miselis, J., Nichols-O'Neill, S. (2022). The effect of development and coastal
...
Methodology
	...
	backbarrier marsh, lagoon and inland marsh polygons. Total area for each region was calculated for 1839/1840, 1879, 1934, 1957 and 2022.
	Average environment cross-shore widths were calculated by dividing environment areas by the field site's alongshore length. Ocean shoreline position
	change was tracked by generating polygons between ocean shorelines of each year of interest along with shorelines in 1993, 2007, and 2012. 
	Average cross-shore shoreline position change was calculated by dividing the difference of the total landward and seaward area change by the field 
	site's alongshore length.Combining ocean shoreline position change with environment boundary change, overall barrier-backbarrier-lagoon system 
	evolution can be analyzed. 
...
Map Info
	...
	1216-8-1957.jpg (1957 Nautical Chart)

		title: Sea Girt Light to Little Egg Inlet
		image: 1216-8-1957
		type: Nautical Chart
		author: US Coast & Geodetic Survey
		publication date: Year = 1957, Month = 8
		scale: 1:80000

		Image from NOAA's Office of Coast Survey Historical Map & Chart Collection https://historicalcharts.noaa.gov
		
	 
		direct url: https://www.historicalcharts.noaa.gov/image.php?filename=1216-8-1957

	12323-4-1983_LBI_region.jpg (1983 Nautical Chart)

		"12323-4-1983_LBI_region.jpg" file was created by clipping the LBI region of interest from the original
		"12323-4-1993.jpg" from NOAA's Office of Coast Survey Historical Map & Chart Collection. The clip was made 
		to lower file sizes for submission to the online database. Metadata for the original image file can be found
		directly below. 
		
		Original File Info 

		12323-4-1993.jpg (1993 Nautical Chart)

		title: Sea Girt Light to Little Egg Inlet
		image: 12323-4-1983
		type: Nautical Chart
		author: US Coast & Geodetic Survey
		publication date: Year = 1983, Month = 4
		scale: 1:80000

		Image from NOAA's Office of Coast Survey Historical Map & Chart Collection https://historicalcharts.noaa.gov
		
	 
		direct url: https://www.historicalcharts.noaa.gov/image.php?filename=12323-4-1983

	12323-4-1993_LBI_region.jpg (1993 Nautical Chart)
		...
		type: Nautical Chart
		author: US Coast & Geodetic Survey
		publication date: Year = 193, Month = 4
		scale: 1:80000

		Image from NOAA's Office of Coast Survey Historical Map & Chart Collection https://historicalcharts.noaa.gov
		
	 
		direct url: https://www.historicalcharts.noaa.gov/image.php?filename=12323-4-1993


	12323-02-2007.jpg (2007 Nautical Chart)

		title: Sea Girt Light to Little Egg Inlet
		image: 12323-02-2007
		type: Nautical Chart
		author: US Coast & Geodetic Survey
		publication date: Year = 2007, Month = 2
		scale: 1:80000

		Image from NOAA's Office of Coast Survey Historical Map & Chart Collection https://historicalcharts.noaa.gov
		
	 
		direct url: https://www.historicalcharts.noaa.gov/image.php?filename=12323-02-2007

	12323-12-2012.jpg (2012 Nautical Chart)

		title: Sea Girt Light to Little Egg Inlet
		image: 12323-12-2012
		type: Nautical Chart
		author: US Coast & Geodetic Survey
		publication date: Year = 2012, Month = 12
		scale: 1:80000

		Image from NOAA's Office of Coast Survey Historical Map & Chart Collection https://historicalcharts.noaa.gov
		
	 
		direct url: https://www.historicalcharts.noaa.gov/image.php?filename=12323-12-2012
...
GIS File Info
	...
	Shapefile: backbarrier_marsh_1840
		...
		Historic map and GIS polygon discrepancy: marsh region near Beach Haven, NJ removed from analysis to prevent marsh loss effect
		related to Beach Haven permanent structure development. Beach Haven was the first significant settlment at LBI and acted as a 
		major source of marsh loss due to development during LBI's undeveloped phase. 
	...
	Shapefile: ocean_shoreline_1840
	
		Line representing 1840 ocean shoreline across field site.
	...
	Shapefile: inland_marsh_1879
		...
		Historic map and GIS polygon discrepancy: Ponds within 1879 inland marsh area are counted as marsh to align with the lower
		resolution 1840 maps, where ponds are not distinguished from marsh. 

	Shapefile: ocean_shoreline_1879
	
		Line representing 1879 ocean shoreline across field site.
	...
	Shapefile: inland_marsh_1934
		...
		Polygons representing 1934 inland marsh coverage area across field site. 

	Shapefile: ocean_shoreline_1934
	
		Line representing 1934 ocean shoreline across field site.

	Shapefile: barrier_1957	
			
		Polygons representing 1957 barrier coverage area across field site. 

	Shapefile: backbarrier_marsh_1957
			
		Polygons representing 1957 backbarrier marsh coverage area across field site. Backbarrier marsh defined as marsh region 
		connected to the barrier. 

	Shapefile: lagoon_1957
			
		Polygons representing 1957 lagoon coverage area across field site. Small islands within lagoon environment are defined
		as lagoon area. 

	Shapefile: inland_marsh_1957
	
		Polygons representing 1957 inland marsh coverage area across field site. 

		Image classifcation was used to define region of inland marsh based on the 1957 Nautical chart (12323-02-2007.jpg). The image
		classification includes boundary lines as inland marsh unlike inland marsh areas for other years included in this study 
		leading to a slight overestimation of inland marsh area in 1957. 

	Shapefile: ocean_shoreline_1957
	
		Line representing 1957 ocean shoreline across field site.

	Shapefile: barrier_1983	
			
		Polygons representing 1983 barrier coverage area across field site. 

	Shapefile: backbarrier_marsh_1983
			
		Polygons representing 1983 backbarrier marsh coverage area across field site. Backbarrier marsh defined as marsh region 
		connected to the barrier.

	Note: shapefiles for 1983 lagoon nor 1983 inland marsh are included in this study. 		

	Shapefile: ocean_shoreline_1983
	
		Line representing 1983 ocean shoreline across field site.

	Shapefile: ocean_shoreline_1993
	
		Line representing 1993 ocean shoreline across field site.

	Shapefile: ocean_shoreline_2007
	
		Line representing 2007 ocean shoreline across field site.

	Shapefile: ocean_shoreline_2012
	
		Line representing 2012 ocean shoreline across field site.
	...
	Shapefile: os_1840_to_1879_change, os_1879_to_1934_change, os_1934_to_1957_chang, os_1957_to_1983_change, os_1983_to_1993_change,
		   os_1993_to_2007_change, os_2007_to_2012_change, os_2012_to_2022_change	

		Polygons representing landward and seaward ocean shoreline movement, bound by the associated year's shorelines and the 
		northern and southern area of interest bnoundaries. 
...
Calculations
	...
	See "environmental_boundary_change_calculations_Aug_2022" spreadsheet in the "calculations" folder. 


Copyright 

	Data generated by this analysis is freely available @ GITHUB LINK. There is no warranty involved with the data generated by this analysis.
	Authors assume no liability involving any use of these data.


Contatct info:

	Shane Nichols-O'Neill

	email: nicholsones1@montclair.edu 